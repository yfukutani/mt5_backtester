...
## 10. 統合ブックのバックテスト集計（2026-07-12・mt5bt portfolio実測）

XM版v1.3（暗号3枠2x込み）とOANDA版（暗号非対応・13枠のまま）の本番リファレンスconfigを
決済ベースで時系列合算した実測値。**FX/SCAは基準ロット（Mult1.0）**・暗号はロット見直し採用値（2x）。

### XM統合ブック（15構成・暗号2x: BTC funding 0.02/BfxRev 0.02/ETH 0.10）

| 枠 | 取引数 | 純利益 | 単独DD |
|---|---|---|---|
| PB USDJPY/GBPJPY/GOLD | 142/158/224 | +60,599/+18,251/+165,495 | 12,390/13,378/21,509 |
| RSI USDJPY/EURUSD/GBPUSD | 350/1086/222 | +7,580/+6,182/+15,979 | 17,300/13,640/5,474 |
| PairTrade / Carry AUDJPY / VBO | 284/26/624 | +20,897/+215,127/+16,354 | 9,260/28,374/17,107 |
| SCA GOLD/USDJPY/GBPJPY | 1030/1720/2684 | +236,390/+12,038/+38,572 | 27,975/17,886/32,980 |
| **BTC funding 2x / BfxRev 2x / ETH 2x** | 74/116/100 | **+78,075/+115,625/+39,050** | 22,007/36,022/20,029 |

- **合算: 純利益 +1,046,214円 / 最大DD 47,861円 / リターン/最大DD 21.9 / 分散効果84%減**
- **月利: +8,718円/月（10年月割り）＝対50万円 +1.74%/月・最大DD 9.6%（対50万）**
- 暗号3枠の寄与: +232,750円（全体の22%）・1xなら+116,289円（差+116,461円=2x化の増分）

### OANDA統合ブック（12構成・暗号なし）

| 枠 | 取引数 | 純利益 | 単独DD |
|---|---|---|---|
| PB USDJPY/GBPJPY/XAUUSD | 124/142/214 | +50,706/+34,800/+188,161 | 9,430/14,017/25,545 |
| RSI USDJPY/EURUSD/GBPUSD | 316/1064/202 | +3,977/+13,905/+13,467 | 13,867/12,810/6,437 |
| PairTrade / Carry AUDJPY / VBO | 288/28/594 | +26,569/+254,750/+23,594 | 8,095/32,726/10,935 |
| SCA XAUUSD※/USDJPY/GBPJPY | 270/1712/2672 | +134,720/+20,529/+25,207 | 18,659/8,204/21,083 |

- **合算: 純利益 +790,385円 / 最大DD 31,562円 / リターン/最大DD 25.0 / 分散効果83%減**
- **月利: +6,587円/月（10年月割り）＝対50万円 +1.32%/月・最大DD 6.3%（対50万）**
- ※SCA XAUUSDのみ2024.01〜の2.5年窓（every_tick 10年はtickデータ約20GB超でディスク不足・
  検証実績と同窓）。OANDAはJPYスプレッド有利でリターン/DD効率がXMを上回る

### 両ブック合算（別口座・計100万円想定）

**月+15,305円 ＝ 対100万円 +1.53%/月**（口座分離のためDDは各口座独立: XM 9.6% / OANDA 6.3%）

### 読み方の注意（誠実な開示）

1. **窓の混在**: FX枠2016.06〜（10年）・暗号2019.09〜/2016.12〜・SCA各窓・OANDA XAUUSD 2024〜。
   月割りは全て「10年÷120ヶ月」の保守的均し。後年参加の枠（暗号・SCA）は実際の稼働期間あたり
   寄与がこの表記より大きい
2. **FX/SCAは基準ロット**: §3シナリオA（デプロイ倍率適用: SCAミックスB3x等）を適用すれば
   FX/SCA側の月利は上がる（過去実測: 月+5.57%対50万）。本集計は「現状のフォワードテスト設定
