...
def main():
    ...
    print(f"XM本番構成 GOLD2枠＋暗号3枠（＋第2セッション） / 入金 {DEPOSIT:,}円 / 目標 月利{TARGET_MONTHLY:.0f}%")
    print("複利はGszラボを有効にしたGOLD枠にしか効かない。暗号3枠は固定ロットのまま。")
    print("equityは決済損益のみで作るのでDDは下限（建玉中の含み損を含まない）。\n")
