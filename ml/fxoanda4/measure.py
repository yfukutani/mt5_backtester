...
JOBS = [
    ...
    # 6-9. ★★ いま最有力（倍率2・Carry 有）に cap で余裕を作れるか。
    #      `M002 OOS` が 101.47% で初めて生存したが、ロスカットまで 1.47pt しかない。
    #      **生存させる話から「実運用に耐える余裕を作る」話に変わった。**
    ("O014", "OOS"), ("O014", "IS"),     # cap70
    ("O011c", "OOS"), ("O011c", "IS"),   # cap50（同じ軸の下端）
    # 10-13. 倍率3・Carry 抜きを cap で救出できるか（優先度は上より下。月利で負けているので）
    ("O012", "IS"), ("O012", "OOS"),
    ("O013", "IS"), ("O013", "OOS"),
    ("O023", "OOS"),   # 14.
    ("O020", "OOS"),   # 15.
