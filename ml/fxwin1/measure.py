...
PROPOSALS = [
    ...
    ("X001", "T036", "対照: T036・cap無し。OOS通期 3.59%月。"
     ...
     cfg(7, 1.0, 3, 0), W24),
    # OOS も回す。fxlev25 の V006（RSI一律4倍・**cap無し**）は 1.56%月・元本割れだったが、
    # V005 は cap80% なので cap の有無が混ざっていて切り分けになっていない。
    # cap を揃えた 55か月 OOS が要る。X005 の 8.58% と直接並べる相手はこれ。
    ("X006", "T036", "切り分け: RSI 3枠だけ一律4倍 ＋ cap80%。"
                     "X005 の効果が『配分』か『RSIの増レバ』かを、capを揃えて決める",
