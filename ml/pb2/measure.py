...
MAGICS = {20260640: "pb", 20261002: "sca1", 20261003: "sca2", 20260641: "pb2"}
...
FIELDS = ["proposal_id", "family", "window", "status", "net", "pf", "dd_pct",
          "monthly_pct", "trades",
          "pb_net", "pb_n", "sca1_net", "sca1_n", "sca2_net", "sca2_n", "pb2_net", "pb2_n",
...
def run_one(name, exe, prop, window):
    ...
    run_id = f"pb2_{window.lower()}_{prop['proposal_id']}_{stamp}_{uuid.uuid4().hex[:4]}"
