# PullbackTrend v1.1 構成比較（USDJPY H1, 過去5年 2021.06.21-2026.06.20）
# 4方向の改善フィルターの寄与を切り分ける
...
# 構成定義: quality / momentum / adx / rr
$configs = @(
    [ordered]@{ name="C0_baseline(allOFF)"; quality="false"; momentum="false"; adx="false"; rr=1.5 },
    [ordered]@{ name="C1_quality_only";     quality="true";  momentum="false"; adx="false"; rr=1.5 },
    [ordered]@{ name="C2_adx_only";         quality="false"; momentum="false"; adx="true";  rr=1.5 },
    [ordered]@{ name="C3_momentum_only";    quality="false"; momentum="true";  adx="false"; rr=1.5 },
...
Write-Host ""
Write-Host "===== PullbackTrend v1.1 構成比較 (USDJPY H1, 2021.06-2026.06) =====" -ForegroundColor Yellow
Write-Host "目標: 勝率60% / 実効RR1.5 / 期待値+0.5R" -ForegroundColor Yellow
