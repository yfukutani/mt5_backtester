# Breakeven yearly backtest 2016-2026
# H4: BE_Trigger=25pips / H1+EU: BE_Trigger=20pips
...
$charts = @(
    [ordered]@{ label="USDJPY_H4"; symbol="USDJPY"; period="H4"; sl=50; tp=110; useDP="true";  dpBars=100; magic=20260610; csvName="be_h4_result.csv"; beTrigger=25 },
    [ordered]@{ label="USDJPY_H1"; symbol="USDJPY"; period="H1"; sl=45; tp=105; useDP="false"; dpBars=60;  magic=20260604; csvName="be_h1_result.csv"; beTrigger=20 },
    [ordered]@{ label="EURUSD_H1"; symbol="EURUSD"; period="H1"; sl=45; tp=105; useDP="false"; dpBars=60;  magic=20260605; csvName="be_eu_result.csv"; beTrigger=20 }
)
...
Write-Host ""
Write-Host "===== Breakeven Yearly Results (H4>=25pips, H1/EU>=20pips) =====" -ForegroundColor Yellow
Write-Host ("{0,-6} {1,12} {2,12} {3,12} {4,10} {5,10} {6,8}" -f "Year","USDJPY_H4","USDJPY_H1","EURUSD_H1","BE-Total","Base-Total","Diff")
Write-Host ("-" * 74)
...
$grandDiff = $grandBE - $grandBase
Write-Host ("-" * 74)
Write-Host ("Grand  {0,45} {1,10} {2,8}" -f (Format-Profit $grandBE), (Format-Profit $grandBase), (Format-Profit $grandDiff))
